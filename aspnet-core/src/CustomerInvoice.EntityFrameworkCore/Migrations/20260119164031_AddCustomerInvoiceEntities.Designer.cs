...
namespace CustomerInvoice.Migrations
{
    ...
    [Migration("20260119164031_AddCustomerInvoiceEntities")]
    partial class AddCustomerInvoiceEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CustomerInvoice.Entities.Customer", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("CustomerInvoice.Entities.Invoice", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CustomerInvoice.Entities.LineItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppLineItems", (string)null);
                });
            ...
            modelBuilder.Entity("CustomerInvoice.Entities.Invoice", b =>
                {
                    b.HasOne("CustomerInvoice.Entities.Customer", "Customer")
                        .WithMany("Invoices")
            ...
            modelBuilder.Entity("CustomerInvoice.Entities.LineItem", b =>
                {
                    b.HasOne("CustomerInvoice.Entities.Invoice", "Invoice")
                        .WithMany("LineItems")
